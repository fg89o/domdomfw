...
#define EEPROM_CHANNEL_MEMORY_SIZE              9
#define EEPROM_CHANNEL_LED_MEMORY_SIZE          6
...
#define EEPROM_SCHEDULE_STATUS_ADDRESS          EEPROM_CHANNEL_FIRST_ADDRESS + (CHANNEL_SIZE * EEPROM_CHANNEL_MEMORY_SIZE) + (CHANNEL_SIZE * EEPROM_CHANNEL_LED_MEMORY_SIZE * CHANNEL_MAX_LEDS_CONFIG)
#define EEPROM_SCHEDULE_FIRST_ADDRESS           EEPROM_SCHEDULE_STATUS_ADDRESS + 1

#define EEPROM_NTP_ENABLED_ADDRESS              EEPROM_SCHEDULE_FIRST_ADDRESS + (EEPROM_MAX_SCHEDULE_POINTS * 5) + (EEPROM_MAX_SCHEDULE_POINTS * CHANNEL_SIZE)
